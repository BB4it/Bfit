...
// delete logo delete_logo_internal
var ids;
$("#delete-logo-internal").on('click', function(){

    // delete from db
    $.ajax({
        url: "/admin/delete/delete_logo_internal" ,
        type: 'POST',
        data: { ids: ids },
        success:function(data){
            window.location.href = data;
...
// delete logo delete_logo_service
var ids;
$("#delete-logo-service").on('click', function(){

    // delete from db
    $.ajax({
        url: "/admin/delete/delete_logo_service" ,
        type: 'POST',
        data: { ids: ids },
        success:function(data){
            window.location.href = data;
