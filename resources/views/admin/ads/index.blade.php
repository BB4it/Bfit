...
@section('page_header')
    ...
    <h1 class="page-title">عرض الاعلانات
        <small>عرض جميع الاعلانات</small>
    </h1>
@endsection
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($ads as $ad)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{$ad->link}} </td>
                                    <td>
                                        <img   src='{{ asset("upload/$ad->image") }}' style="height: 50px; width: 50px;" alt="{{$ad->image}}">
                                    </td>
                                    ...
                                    <td>
                                       @if($ad->place == 1)
                                           الصفحة الداخلية
                                       @elseif($ad->place == 2)
                                           الصفحة الرئيسية-البانر العريض
                                       @elseif($ad->place == 3)
                                           الصفحة الرئيسية-البانر الطويل
                                       @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <li>
                                        <a href="/admin/edit/ads/{{$ad->id}}">
                                        <i class="icon-docs"></i> تعديل </a>
                                        </li>

                                        <li>
                                            <a class="delete_ad" data="{{$ad->id}}" data_name="{{$ad->title}}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_ad', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/ads";
