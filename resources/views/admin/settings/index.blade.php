                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <input type="text" class="form-control" placeholder="اسم الموقع" name="name" value="{{$settings->name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="الوصف" name="description" value="{{$settings->description}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="كلمات دلالية" name="keywords" value="{{$settings->keywords}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="البريد الاكتروني" name="email" value="{{$settings->email}}">
                                        </div>
                                        @if ($errors->has('email'))
                                            <span class="help-block">
