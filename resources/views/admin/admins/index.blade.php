...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>عرض الادمن</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض الادمن
        <small>عرض جميع الادمن</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="/admin/add/admin"> إضافة جديد
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a href="/admin/edit/admin/{{$user->id}}">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/admin";
