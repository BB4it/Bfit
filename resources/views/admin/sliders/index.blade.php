                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($sliders as $slider)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{$slider->order}} </td>
                                    <td>
                                        <img   src='{{ asset("uploads/sliders/$slider->image") }}' style="height: 50px; width: 50px;" alt="{{$slider->image}}">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <li>
                                        <a href="/admin/edit/slider/{{$slider->id}}">
                                        <i class="icon-docs"></i> تعديل </a>
                                        </li>

                                        <li>
                                            <a class="delete_slider" data="{{$slider->id}}" data_name="{{$slider->title}}" >
