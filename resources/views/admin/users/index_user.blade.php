                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                <a class="btn sbold green" href="/admin/add/user/2"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($users as $user)
                            <tr class="odd gradeX">
                                ...
                                @endif
                                <td><a href="{{url('admin/userWeight/'.$user->id)}}" class="btn btn-xs green btn-outline"> <i class="icon-eye"></i>عرض </a></td>
