                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form role="form" action="/admin/add/user/2" method="post" enctype="multipart/form-data">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">الصورة الشخصية للمستخدم</label>
                                                <input type="file" name="image" placeholder="الصورة الشخصية للمستخدم" class="form-control"  />
                                                ...
                                                <div class=" input-group select2-bootstrap-append">
                                                    <select  name="city_id" class="form-control select2-allow-clear" id="register_city">
                                                        @foreach($cities as $city)
                                                            <option value="{{$city->id}}" {{ old('city_id')== $country->id ? 'selected' : '' }}>{{$city->name_ar}}</option>
                                                        @endforeach
