...
@section('page_header')
    ...
    <h1 class="page-title">عرض المطلوب في الخدمات
        <small>عرض جميع المطلوب في الخدمات</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="/admin/services/add/requiredServices">
                        ...
                        @foreach($services as $service)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <li>
                                        <a href="/admin/services/edit/requiredServices/{{$service->id}}">
                                        <i class="icon-docs"></i> تعديل </a>
                                        </li>

                                        <li>
                                            <a class="delete_service" data="{{$service->id}}" data_name="{{$service->text}}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_service', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/services/delete/"+id+"/requiredServices";
