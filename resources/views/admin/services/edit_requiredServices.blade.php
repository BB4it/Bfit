...
@section('page_header')
    ...
    <h1 class="page-title">عرض المطلوب في الخدمات
        <small>تعديل جميع المطلوب في الخدمات</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="/admin/services/update/requiredServices/{{$service->id}}" enctype="multipart/form-data"  >
                                        ...
                                        <div class="form-horizontal" role="form">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="text" class="form-control" placeholder="النص" value="{{$service->text}}">
                                                        @if ($errors->has('text'))
