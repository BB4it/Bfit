...
<div class="page-lock">
    <div class="page-logo">
        <a class="brand" href="/admin/home">
            <img src="../assets/pages/img/logo.png" alt="logo" /> </a>
    </div>
    <div class="page-body">
        <div class="lock-head"> تحذير </div>
        <div class="lock-body">
            <div class="lock-cont">

                <div class="lock-item lock-item-full lock-form pull-left">

                        <h4>أنت لست مدير الموقع</h4>

                </div>
            </div>
        </div>
        <div class="lock-bottom">
            <a href="/admin/login">عودة إلى الصفحة الدخول</a>
        </div>
    </div>
